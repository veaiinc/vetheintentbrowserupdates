...
#   6. sparkle    : sign_update Ve-<version>.dmg --ed-key-file \
#                     ~/Desktop/Vetheintentbrowser/.secrets/sparkle_ed_private.key
#                   -> sparkle:edSignature + length  (public key SUPublicEDKey in Info.plist;
#                      see SPARKLE.md)
